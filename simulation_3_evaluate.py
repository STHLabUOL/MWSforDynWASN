...
WASN_MODIFICATION = 'join' # 'join', 'unlink', 'leave', 'leave_root'

# Evaluate WASN signals generated by  simulation_2_simulate_WASNs.py
# for topologies from topologies_my.pkl
# SIM_DATA_ROOT = 'results/simulation/'
# EVAL_TARGET_ROOT = 'results/evaluation/'
...
SIM_DATA_DIR = SIM_DATA_ROOT+WASN_MODIFICATION+'/'
EVAL_TARGET_DIR = EVAL_TARGET_ROOT+('before/' if EVAL_BEFORE_SEGMENT else 'after/'+WASN_MODIFICATION+'/')
